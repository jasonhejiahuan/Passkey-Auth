...
- SQLite persistence for users, credentials, OAuth codes, and challenge requests
- Modern Auth WebUI and related frontend behavior
- Unit tests for config, registration gating, OAuth callback, and challenge flow behavior
...
The AI collaborator was OpenAI Codex, accessed through an agentic coding environment.
